...
*Survey ID's
global ccode = "GIN"                                                                      // Country 3 Digit Name to replace "PAK", keep quotation marks.
global year = 2012                                                                       // 4 digit Year to replace "2014", keep keep quotation marks.
global survey = "ELEP"        															// Survey Acro Name to replace "LFS", keep quotation marks.

global isic_dig = 1
global occup_dig = .                                                            			// Industry digit of aggregation
...
gdld_classifications, isic_corr(5) isic_dig(${isic_dig}) occup_corr(3) occup_dig(1)
